  ...
  return (
      <footer className={`${styles.footer}`}>
        ...
        <div className={`${styles.branding}`}>
          <Image src={"/branding/jq-icon-light.svg"} alt={"Justin Quinn logo"} width={75} height={75} />
          <p className={`${styles.slogan}`}>Creating with <br /><span className={`emphasis`}>Purpose</span>.</p>
        </div>
      </footer>
  );
}